...
const Signup = () => {
  ...
  const handleGoogleSignup = () => { window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/api/auth/google` }
      ...
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .left-tag {
          ...
          border: 1px solid rgba(0,217,255,0.2); background: rgba(0,217,255,0.06);
          color: #00d9ff; font-size: 0.72rem; font-weight: 700;
        ...
        .auth-logo-mark {
          ...
          display: flex; align-items: center; justify-content: center;
          color: #00d9ff; margin-bottom: 1.5rem;
        }
        ...
        .submit-btn {
          ...
          background: #00d9ff; color: #050b18;
        ...
        .spinner {
          ...
          border: 2px solid rgba(5,11,24,0.3); border-top-color: #050b18;
      ...
      <div className="auth-page">
        ...
        <div className="auth-left">
          ...
          <div className="left-body">
            ...
            <h2 className="left-heading">Turn your resume<br />into a <span>portfolio</span></h2>
            <p className="left-sub">Upload your CV and get a stunning personal portfolio website in minutes.</p>
            <div className="left-features">
              {['AI extracts your skills & experience', 'Choose from 25+ premium themes', 'Download ready-to-deploy HTML', 'No coding required'].map((f, i) => (
          ...
          <div className="auth-card">
            ...
            <form onSubmit={signupForm.handleSubmit}>
              <div className="form-group">
                ...
                <input className="form-input" type="text" name="name" placeholder="Naman Gupta"
                  onChange={signupForm.handleChange} onBlur={signupForm.handleBlur} value={signupForm.values.name} />
                {signupForm.touched.name && signupForm.errors.name && <div className="form-error">{signupForm.errors.name}</div>}
              </div>
              <div className="form-group">
                <label className="form-label">Email address</label>
                <input className="form-input" type="email" name="email" placeholder="you@example.com"
                  onChange={signupForm.handleChange} onBlur={signupForm.handleBlur} value={signupForm.values.email} />
                {signupForm.touched.email && signupForm.errors.email && <div className="form-error">{signupForm.errors.email}</div>}
              </div>
              <div className="form-group">
                <label className="form-label">Password</label>
                <input className="form-input" type="password" name="password" placeholder="Min. 6 characters"
                  onChange={signupForm.handleChange} onBlur={signupForm.handleBlur} value={signupForm.values.password} />
                {signupForm.touched.password && signupForm.errors.password && <div className="form-error">{signupForm.errors.password}</div>}
              </div>
              <div className="form-group">
                <label className="form-label">Confirm password</label>
                <input className="form-input" type="password" name="confirmPassword" placeholder="••••••••"
                  onChange={signupForm.handleChange} onBlur={signupForm.handleBlur} value={signupForm.values.confirmPassword} />
                {signupForm.touched.confirmPassword && signupForm.errors.confirmPassword && <div className="form-error">{signupForm.errors.confirmPassword}</div>}
              </div>
